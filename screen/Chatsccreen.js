...
const Chatsccreen = ({ navigation, route }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        setfetchmessage(fetchedMessages);
      },
      (error) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        {/* Wrap content with TouchableWithoutFeedback to dismiss keyboard */}
          ...
          <>
                ...
                data.email === auth.currentUser.email ? (
                  <View key={id} style={styles.receiver}>
                    <Image
                      ...
                      style={{ width: 40, height: 40, borderRadius: 20 }}
                    />
                    <Text style={styles.receivertest}>{data.mes}</Text>
                  </View>
                ) : (
                  <View style={styles.sender} key={id}>
                    ...
                    <Text style={styles.sendertest}>{data.mes}</Text>
                  </View>
                )
              )}
            </ScrollView>
            ...
            <View style={styles.footer}>
              ...
              <TouchableOpacity onPress={sendMessage}>
                <Icon name="send" color="blue" size={25} />
              </TouchableOpacity>
            </View>
          </>
